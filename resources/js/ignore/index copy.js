...
const actions = {
  ...
  deleteStoreTask:({ commit, state }, taskID)=>{
    ...
    // state.currentProject.stages.forEach(element => {
    ...
    //   }
    // });
    // state.currentProject = state.currentProject.filter(item => {
    ...
    // );
    // deletedTask =
    // console.log(state.currentProject.stages)
    // commit("DELETE_STORE_TASK", taskID);
  },
