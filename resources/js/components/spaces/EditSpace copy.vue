      ...
      <template v-slot:activator="{ on, attrs }">
        <v-hover v-slot="{ hover }">
          <v-btn
            ...
            v-on="on"
          >
            <v-icon color="#49d9a0"> mdi-pencil </v-icon>
          </v-btn>
        </v-hover>
        <v-hover v-slot="{ hover }">
          <v-btn
            ...
            :class="{ 'show-btns': hover }"
          >
            <v-icon color="#49d9a3"> mdi-delete </v-icon>
          </v-btn>
        </v-hover>
      </template>
      ...
      <v-stepper v-model="e1">
        ...
        <v-stepper-items>
          ...
          <v-stepper-content step="4">
            haych ma
            <v-btn color="primary" @click="editSpace(currentSpace)"> Edit </v-btn>
            <v-btn text @click="dialog = false"> Cancel </v-btn>
          </v-stepper-content>
        </v-stepper-items>
      </v-stepper>
...
export default {
  ...
  methods: {
    ...
    deleteSpace(space) {
      this.$store.dispatch("deleteSpace", space)
      .then(() => {
